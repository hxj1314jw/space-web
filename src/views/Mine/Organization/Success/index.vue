        ...
        <template slot="text">
          <div style="text-align: center; margin-top: 20px; line-height: 1.5em;">
            ...
            <div style="margin: 20px 0;">
              ...
              <van-button @click="toMineOrg()" plain type="primary" size="small" style="margin: 0 5px; width: 80px">我的组织</van-button>
            </div>
          </div>
        </template>
      </van-grid-item>
...
export default class AddOrgSuccessfully extends Vue {
  private toHome() {
    this.$router.push('/');
  }

  private toMineOrg() {
    this.$router.push('/mine/organization');
  }
}
</script>